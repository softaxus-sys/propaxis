  ...
  return (
    <>
      ...
      <main className="flex-1 bg-sand-50 py-10">
        <Container>
          <h1 className="text-2xl font-semibold text-ink-950">Agencies</h1>
          <p className="mt-1 text-sm text-sand-600">Real estate agencies operating across the UAE.</p>
              ...
              <Link key={agency.slug} href={`/agencies/${agency.slug}`}>
                <Card className="p-5 transition-shadow hover:shadow-md">
                  ...
                  <p className="mt-2 text-xs text-sand-500">
                    {agency._count.agents} agents · {agency._count.listings} listings
                  </p>
                </Card>
              </Link>
            ))}
