  ...
  return (
    <>
      ...
      <main className="flex-1 bg-sand-50 py-10">
        <Container>
          <h1 className="text-2xl font-semibold text-ink-950">{dict.search.commercialTitle}</h1>
          <p className="mt-1 text-sm text-sand-600">{dict.search.commercialSubtitle}</p>
