  ...
  return (
    <>
      ...
      <main className="flex-1 bg-sand-50 py-10">
        <Container>
          <h1 className="text-2xl font-semibold text-ink-950">Find an agent</h1>
          <p className="mt-1 text-sm text-sand-600">Verified agents and brokers across the UAE.</p>
              ...
              <Link key={agent.slug} href={`/agents/${agent.slug}`}>
                <Card className="flex items-start gap-4 p-5 transition-shadow hover:shadow-md">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 text-xs text-sand-500">{agent._count.listings} active listings</p>
                  </div>
                </Card>
              </Link>
            ))}
