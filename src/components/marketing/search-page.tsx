...
export async function SearchPage({
  ...
  const title = listingType === "SALE" ? dict.search.buyTitle : dict.search.rentTitle;
      ...
      <main className="flex-1 bg-sand-50 py-10">
        <Container>
          ...
          <p className="mt-1 text-sm text-sand-600">
            {result.total.toLocaleString()} {result.total === 1 ? dict.search.listingFound : dict.search.listingsFound}
          </p>

          <div className="mt-6">
            <SearchFilters dict={dict} />
          </div>
